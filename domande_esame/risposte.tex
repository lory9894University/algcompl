...
\end{figure*}\\
	...
	\end{enumerate}
\end{itemize}
%TODO:  ISERIRE UN ESEMPIO PER OGNUNA (grafo, matrice e albero di esplorazione). si possono prendere quelli del prof
\subsection{B.3}
...
%todo: volendo aggiungere immagine triangolo con w1, w2 etc
		\begin{align}
...
\begin{align}        
	...
	\end{cases}
	\end{equation}
%todo: volendo aggiungere immagine (quella di sopra)
...
\begin{itemize}
	...
	%todo: aggiungere l'immagine con confronto tra valore con xsplit e s4nza
\end{itemize}
...
\end{itemize}
%todo:IMMAGINE TABELLA SU CUI FARE L'ESEMPIO QUANDO IL PROF LA CARICA
