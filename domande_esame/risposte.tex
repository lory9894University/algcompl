...
entrambe gli algoritmi prendono come riferimento una struttura ad albero.

La differenza sta in come la usano. Entrambi fanno una visita in profondità
%rappresentare graficamente la struttura dati?
Bk è la funzione di bound. T restituisce un ramo data una sequenza di x da 1 a k
parto da k=1 e

%https://drive.google.com/file/d/1QRzbhvOApvdxzxp6NivopsDgRI3gBpzG/view pagina 10 e 11
...
\subsection{C.5}
recordo è un nodo
listnode è una lista di record.

%listnode definisce una struttura dati che rappresenta uno spazio degli stati ad albero.
% volendo si piò aggiungere che a seconda di come è implementata listnode () abbiamo un differente comportamento nel caso in cui abbiamo due nodi con lo stesso costo.
\subsection{C.6}
